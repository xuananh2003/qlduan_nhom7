...
const [count, setCount] = useState(0);
  ...
  const  Save_UserMua = () =>{
    let objUserMua = {img_pro:img_pro , tensp:tensp, giasp:giasp, tennguoimua:tennguoimua, sdt:sdt, diachi:diachi, soluong:count}
    let url_api_lichsu = 'http://172.16.10.106:3000/list_lichsu'

    fetch(url_api_lichsu, {
        method: 'POST',
        headers: {
